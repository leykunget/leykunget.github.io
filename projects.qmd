...
This application predicts childhood micronutrient deficiency using machine learning. It employs an XGBoost model trained on various demographic and health-related features. The model was developed using the tidymodels framework and demonstrates good predictive performance. Access the app here: [Childhood Micronutrient Deficiency Prediction Tool](https://01940f43-8b51-7a58-d5b7-df79a7e7dae5.share.connect.posit.cloud/)
